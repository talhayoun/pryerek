        ...
        <div className="product-showcase">
            ...
            <div className="product-showcase-add-to-cart-form">
                <div style={{ display: "flex" }}>
                    <span
                        style={{
                            backgroundColor: unit == "יחידה" || unit == 'חבילה' ? "#3fbc72" : "#e0f6ea",
                            padding: "5px 10px",
                            borderTopRightRadius: "20px",
                            borderBottomRightRadius: "20px",
                            color: unit == "יחידה" || unit == 'חבילה' ? "#fff" : "#3fbc72",
                        }}
                    >
                        יח
                    </span>
                    <span
                        style={{
                            backgroundColor: unit == "יחידה" || unit == 'חבילה' ? "#e0f6ea" : "#3fbc72",
                            padding: "5px 10px",
                            borderTopLeftRadius: "20px",
                            borderBottomLeftRadius: "20px",
                            color: unit == "יחידה" || unit == 'חבילה' ? "#3fbc72" : "#fff",
                        }}
                    >
                        קג
                    </span>
